    ...
    try{
        ...
        let containerToAdd = document.getElementById("items")
            ...
            itemToAdd.innerHTML = `
                ...
                <h1 class="text-[20px] font-bold">${itemTitle.slice(0,18)}</h1>
...
function AddNewItems() {
    let containerToAdd = document.getElementById("items")
    let NewProducts = JSON.parse(localStorage.getItem("arrayAddNewProducts")) || []
    arrayAddNewProducts.push(...NewProducts)
    ...
    arrayAddNewProducts.forEach(element => {
        ...
        let itemToAdd = document.createElement("div")
        itemToAdd.setAttribute("id",itemId)
        itemToAdd.setAttribute("class","bg-white w-[250px] h-[450px] shadow-xl border border-[#a0a2a8] rounded-2xl flex flex-col justify-between items-center p-2 my-2 mx-2 transition-all hover:scale-105 ease-out duration-1000")
        itemToAdd.innerHTML = `
            <img class="w-[90%] h-[200px]" src="${itemSrc}" alt="">
